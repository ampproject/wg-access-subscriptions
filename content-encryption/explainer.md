...
Let's assume that the document encryption is done using [AES-CTR-256](https://tools.ietf.org/html/rfc3686#section-2.1) — it's a simple and strong algorithm that allows streaming. The keys are 256 bit in length.
